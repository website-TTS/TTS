...
@section('container')
    <div class="reponsive" > 
        <div class="Container">
            <a class="nav-reponsive-container-buy" href="shoppingcart">
                    ...
                    <div class="content-sale-box">
                        ...
                        <div class="content-sale-list">
                            ...
                            <div class="content-sale-list-item">
                                ...
                                <a href="{{route('themgiohang',$line_table_dell->id)}}" class="buy_now" name="cart">Mua ngay</a>
                            </div>
                            @endforeach 
                        </div>
                    </div>  
                    <div class="content-sale-box">
                        ...
                        <div class="content-sale-list">
                            ...
                            <div class="content-sale-list-item">
                                ...
                                <a href="{{route('themgiohang',$line_table_acer->id)}}" class="buy_now" name="add_Cart">Mua ngay</a>
                            </div>
                            @endforeach 
                        </div>
                    </div>      
                    <div class="content-sale-box">
                        ...
                        <div class="content-sale-list">
                            ...
                            <div class="content-sale-list-item">
                                ...
                                <a href="{{route('themgiohang',$line_table_asus->id)}}" class="buy_now" name="add_Cart">Mua ngay</a>
                            </div>
                            @endforeach
                        </div>
                    </div> 
                    <div class="content-sale-box">
                        ...
                        <div class="content-sale-list">
                            ...
                            <div class="content-sale-list-item">
                                ...
                                <a href="{{route('themgiohang',$line_table_hp->id)}}" class="buy_now" name="add_Cart">Mua ngay</a>
                            </div>
                             @endforeach
                        </div>
                    </div>            
                    <div class="content-sale-box">
                        ...
                        <div class="content-sale-list">
                            ...
                            <div class="content-sale-list-item">
                                ...
                                <a href="{{route('themgiohang',$line_table_lenovo->id)}}" class="buy_now" name="add_Cart">Mua ngay</a>
                            </div>
                            @endforeach
                        </div>
                    </div>      
                    <div class="content-sale-box">
                        ...
                        <div class="content-sale-list">
                            ...
                            <div class="content-sale-list-item">
                                ...
                                <a href="{{route('themgiohang',$line_table_msi->id)}}" class="buy_now" name="add_Cart">Mua ngay</a>
                            </div>
                            @endforeach
                        </div>
                    </div>              
